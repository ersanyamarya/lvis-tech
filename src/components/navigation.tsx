  ...
  return (
    <>
      <Navbar>
        ...
        <NavLinkContainer className={visible ? 'visible' : ''}>
          <NavLink
            onClick={() => {
          ...
          <Icon className={expanded ? '' : 'rotate'} width="14" height="8" viewBox="0 0 14 8" fill="none">
            <path
        ...
        <BigButtonYellowShadow onClick={() => scrollTo(`#contact-section`)}>CONTACT US</BigButtonYellowShadow>
        <ChildNav
          onMouseEnter={() => {
            setExpanded(true)
          }}
